...
namespace UnityEditorInternal.VersionControl
{
  public class Overlay
  {
    ...
    private static void DrawOverlays(Asset asset, Asset metaAsset, Rect itemRect)
    {
      ...
      Rect iconRect4 = new Rect(itemRect.xMax - num1 + num2, itemRect.yMax - num1 + num3, num1, num1);
      Rect iconRect5 = new Rect(itemRect.xMax - num1 + num4, itemRect.yMax - num1 + num3, num1, num1);
