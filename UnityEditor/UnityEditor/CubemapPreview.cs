...
namespace UnityEditor
{
  internal class CubemapPreview
  {
    ...
    public void OnPreviewSettings(Object[] targets)
    {
      ...
      {
        a = Mathf.Max(a, TextureUtil.GetMipmapCount(target));
    ...
    {
      public static GUIStyle preButton = (GUIStyle) nameof (preButton);
      public static GUIStyle preSlider = (GUIStyle) nameof (preSlider);
      public static GUIStyle preSliderThumb = (GUIStyle) nameof (preSliderThumb);
      public static GUIStyle preLabel = (GUIStyle) nameof (preLabel);
