  ...
  public class EditorWindow : ScriptableObject
  {
    ...
    public static T GetWindow<T>(string title, bool focus, params System.Type[] desiredDockNextTo) where T : EditorWindow
    {
      ...
      foreach (System.Type type in desiredDockNextTo)
      {
        ...
        EditorWindow.\u003CGetWindow\u003Ec__AnonStorey0<T> windowCAnonStorey0 = new EditorWindow.\u003CGetWindow\u003Ec__AnonStorey0<T>();
        // ISSUE: reference to a compiler-generated field
        windowCAnonStorey0.desired = type;
        foreach (ContainerWindow window in ContainerWindow.windows)
        {
          foreach (View allChild in window.rootView.allChildren)
          {
            ...
            if (!((UnityEngine.Object) dockArea == (UnityEngine.Object) null) && dockArea.m_Panes.Any<EditorWindow>(new Func<EditorWindow, bool>(windowCAnonStorey0.\u003C\u003Em__0)))
            {
