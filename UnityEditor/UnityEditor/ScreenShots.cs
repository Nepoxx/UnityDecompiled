...
namespace UnityEditor
{
  internal class ScreenShots
  {
    ...
    {
      UnityEngine.Resources.FindObjectsOfTypeAll<MainView>()[0].window.position = new Rect(0.0f, 0.0f, 1024f, 768f);
    }

    [MenuItem("Window/Screenshot/Set Window Size Small", false, 1000, true)]
    public static void SetMainWindowSizeSmall()
    {
      UnityEngine.Resources.FindObjectsOfTypeAll<MainView>()[0].window.position = new Rect(0.0f, 0.0f, 762f, 600f);
    }
    ...
    public static void ScreenshotExtendedRight()
    {
      ...
      MainView mainView = UnityEngine.Resources.FindObjectsOfTypeAll<MainView>()[0];
      Rect screenPosition = mouseOverView.screenPosition;
    ...
    private static string SaveScreenShot(int width, int height, Color[] pixels, string name)
    {
      ...
      Object.DestroyImmediate((Object) tex, true);
