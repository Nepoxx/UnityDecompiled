...
namespace UnityEditor
{
  internal class TransitionPreview
  {
    ...
    private float m_LeftStateWeightA = 0.0f;
    private float m_LeftStateWeightB = 1f;
    private float m_LeftStateTimeA = 0.0f;
    private float m_LeftStateTimeB = 1f;
    private float m_RightStateWeightA = 0.0f;
    private float m_RightStateWeightB = 1f;
    private float m_RightStateTimeA = 0.0f;
    ...
    {
      bool flag = this.m_AvatarPreview != null && (UnityEngine.Object) this.m_AvatarPreview.Animator != (UnityEngine.Object) null && this.m_AvatarPreview.Animator.recorderMode == AnimatorRecorderMode.Playback;
    ...
    private void ResampleTransition(AnimatorStateTransition transition, AvatarMask layerMask, TransitionPreview.TransitionInfo info, Animator previewObject)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          bool flag3 = false;
          bool flag4 = false;
          if ((double) this.m_RefTransition.exitTime == 0.0)
            this.m_AvatarPreview.Animator.CrossFade(0, 0.0f, 0, 0.9999f);
          ...
          while (!flag4 && (double) num5 < (double) num1)
          {
          ...
          else
          {
            ...
            if (this.m_MustSampleMotions)
            {
              ...
              {
                this.m_DstPivotList.Add(new TimelineControl.PivotSample()
                {
                  m_Time = num10,
              ...
              {
                this.m_SrcPivotList.Add(new TimelineControl.PivotSample()
                {
                  m_Time = num12,
                  m_Weight = this.m_AvatarPreview.Animator.pivotWeight
                });
            ...
            if (flag1)
            {
              TimelineControl timeline = this.m_Timeline;
            ...
            this.m_AvatarPreview.Animator.playbackTime = 0.0f;
            this.m_AvatarPreview.Animator.Update(0.0f);
    ...
    public void OnDestroy()
    {
      this.ClearController();
      if (this.m_Timeline != null)
        this.m_Timeline = (TimelineControl) null;
      if (this.m_AvatarPreview == null)
        return;
      this.m_AvatarPreview.OnDestroy();
      this.m_AvatarPreview = (AvatarPreview) null;
