  ...
  internal class LayerVisibilityWindow : EditorWindow
  {
    ...
    private void CalcValidLayers()
    {
      ...
      for (int layer = 0; layer < 32; ++layer)
      {
        ...
        {
          this.s_LayerNames.Add(string.Format("{0}: {1}", (object) layer, (object) layerName));
    ...
    {
      foreach (EditorWindow editorWindow in UnityEngine.Resources.FindObjectsOfTypeAll(typeof (SceneView)))
