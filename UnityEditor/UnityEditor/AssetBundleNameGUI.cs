...
namespace UnityEditor
{
  internal class AssetBundleNameGUI
  {
    ...
    public void OnAssetBundleNameGUI(IEnumerable<UnityEngine.Object> assets)
    {
      ...
      int controlId1 = GUIUtility.GetControlID(AssetBundleNameGUI.kAssetBundleNameFieldIdHash, FocusType.Passive, controlRect);
      ...
      int controlId2 = GUIUtility.GetControlID(AssetBundleNameGUI.kAssetBundleVariantFieldIdHash, FocusType.Passive, rect1);
    ...
    private void AssetBundleTextField(Rect rect, int id, IEnumerable<UnityEngine.Object> assets, bool isVariant)
    {
      ...
      string name = EditorGUI.DelayedTextFieldInternal(rect, id, GUIContent.none, "", (string) null, AssetBundleNameGUI.Styles.textField);
    ...
    private void AssetBundlePopup(Rect rect, int id, IEnumerable<UnityEngine.Object> assets, bool isVariant)
    {
      ...
      if (!isVariant)
      {
        ...
        if (bundlesFromAssets.Count<string>() != 0)
          stringList.Add("Filter Selected Name" + (!isMixed ? "" : "s"));
      }
      int selected = 0;
    ...
    private class Styles
    {
      ...
      public static GUIStyle textField = AssetBundleNameGUI.Styles.GetStyle(nameof (textField));
