  ...
  internal class AudioMixerWindow : EditorWindow, IHasCustomMenu
  {
    ...
    private void Init()
    {
      ...
      if (this.m_LayoutStripsOnTop.m_VerticalSplitter == null || this.m_LayoutStripsOnTop.m_VerticalSplitter.realSizes.Length != 2)
        this.m_LayoutStripsOnTop.m_VerticalSplitter = new SplitterState(new int[2]
        {
          65,
          35
        }, new int[2]{ 85, 105 }, (int[]) null);
      if (this.m_LayoutStripsOnTop.m_HorizontalSplitter == null || this.m_LayoutStripsOnTop.m_HorizontalSplitter.realSizes.Length != 4)
        this.m_LayoutStripsOnTop.m_HorizontalSplitter = new SplitterState(new int[4]
        {
          60,
          60,
          60,
          60
        }, new int[4]{ 85, 85, 85, 85 }, (int[]) null);
      ...
      if (this.m_LayoutStripsOnRight.m_HorizontalSplitter == null || this.m_LayoutStripsOnRight.m_HorizontalSplitter.realSizes.Length != 2)
        this.m_LayoutStripsOnRight.m_HorizontalSplitter = new SplitterState(new int[2]
        {
          30,
          70
        }, new int[2]{ 160, 160 }, (int[]) null);
      if (this.m_LayoutStripsOnRight.m_VerticalSplitter == null || this.m_LayoutStripsOnRight.m_VerticalSplitter.realSizes.Length != 4)
        this.m_LayoutStripsOnRight.m_VerticalSplitter = new SplitterState(new int[4]
        {
          60,
          60,
          60,
          60
        }, new int[4]{ 100, 85, 85, 85 }, (int[]) null);
      ...
      this.m_MixersTree = new AudioMixersTreeView(this, (TreeViewState) this.m_MixersTreeState, new Func<List<AudioMixerController>>(this.GetAllControllers));
    ...
    private static List<AudioMixerController> FindAllAudioMixerControllers()
    {
      ...
      {
        classNames = new string[1]{ "AudioMixerController" }
      });
    ...
    private void LayoutWithStripsOnTop(List<AudioMixerGroupController> allGroups, Dictionary<AudioMixerEffectController, AudioMixerGroupController> effectMap)
    {
      ...
      float y1 = !this.m_GroupsRenderedAboveSections ? (float) (17 + verticalSplitter.realSizes[0]) : 17f;
      float height = !this.m_GroupsRenderedAboveSections ? (float) verticalSplitter.realSizes[1] : (float) verticalSplitter.realSizes[0];
      float y2 = this.m_GroupsRenderedAboveSections ? (float) (17 + verticalSplitter.realSizes[0]) : 17f;
      ...
      EditorGUI.DrawRect(new Rect(0.0f, (float) (17 + verticalSplitter.realSizes[0] - 1), this.position.width, 1f), new Color(0.0f, 0.0f, 0.0f, 0.4f));
    }
