...
namespace UnityEditor
{
  ...
  public sealed class EditorGUILayout
  {
    ...
    {
      GUIStyle foldout1 = EditorStyles.foldout;
      return EditorGUILayout.Foldout(foldout, content, toggleOnLabelClick, foldout1);
    }
    ...
    {
      return EditorGUI.DelayedDoubleField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(false, 16f, EditorStyles.numberField, options), value);
    }
    ...
    {
      return EditorGUI.DelayedDoubleField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(false, 16f, style, options), value, style);
    }
    ...
    {
      return EditorGUI.DelayedDoubleField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(true, 16f, EditorStyles.numberField, options), label, value);
    }
    ...
    {
      return EditorGUI.DelayedDoubleField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(true, 16f, style, options), label, value, style);
    }
    ...
    {
      EditorGUI.SliderWithTexture(EditorGUILayout.s_LastRect = EditorGUILayout.GetSliderRect(false, options), label, property, leftValue, rightValue, power, sliderStyle, thumbStyle, sliderBackground);
    }
    ...
    {
      EditorGUI.MinMaxSlider(EditorGUILayout.s_LastRect = EditorGUILayout.GetSliderRect(true, options), label, ref minValue, ref maxValue, minLimit, maxLimit);
    }
    ...
    {
      return EditorGUI.EnumFlagsField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(false, 16f, style, options), enumValue, style);
    }
    ...
    {
      return EditorGUI.EnumFlagsField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(true, 16f, style, options), label, enumValue, style);
    }
    ...
    {
      EditorGUILayout.ObjectField(property, (GUIContent) null, options);
    }
    ...
    {
      EditorGUILayout.ObjectField(property, objType, (GUIContent) null, options);
    }
    ...
    {
      EditorGUI.ObjectField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(true, 16f, EditorStyles.objectField, options), property, objType, label);
    }

    internal static UnityEngine.Object MiniThumbnailObjectField(GUIContent label, UnityEngine.Object obj, System.Type objType, params GUILayoutOption[] options)
    {
      return EditorGUI.MiniThumbnailObjectField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(true, 16f, options), label, obj, objType);
    }
    ...
    {
      return EditorGUI.Vector2Field(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(true, EditorGUI.GetPropertyHeight(SerializedPropertyType.Vector2, label), EditorStyles.numberField, options), label, value);
    }
    ...
    {
      return EditorGUI.Vector3Field(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(true, EditorGUI.GetPropertyHeight(SerializedPropertyType.Vector3, label), EditorStyles.numberField, options), label, value);
    }
    ...
    {
      return EditorGUI.Vector4Field(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(true, EditorGUI.GetPropertyHeight(SerializedPropertyType.Vector4, label), EditorStyles.numberField, options), label, value);
    }
    ...
    {
      return EditorGUI.Vector2IntField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(true, EditorGUI.GetPropertyHeight(SerializedPropertyType.Vector2Int, label), EditorStyles.numberField, options), label, value);
    }
    ...
    {
      return EditorGUI.Vector3IntField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(true, EditorGUI.GetPropertyHeight(SerializedPropertyType.Vector3Int, label), EditorStyles.numberField, options), label, value);
    }
    ...
    {
      return EditorGUI.RectField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(false, EditorGUI.GetPropertyHeight(SerializedPropertyType.Rect, GUIContent.none), EditorStyles.numberField, options), value);
    }
    ...
    public static Rect RectField(GUIContent label, Rect value, params GUILayoutOption[] options)
    {
      ...
      return EditorGUI.RectField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(hasLabel, propertyHeight, EditorStyles.numberField, options), label, value);
    }
    ...
    {
      return EditorGUI.RectIntField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(false, EditorGUI.GetPropertyHeight(SerializedPropertyType.RectInt, GUIContent.none), EditorStyles.numberField, options), value);
    }
    ...
    public static RectInt RectIntField(GUIContent label, RectInt value, params GUILayoutOption[] options)
    {
      ...
      return EditorGUI.RectIntField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(hasLabel, propertyHeight, EditorStyles.numberField, options), label, value);
    }
    ...
    {
      return EditorGUI.BoundsField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(false, EditorGUI.GetPropertyHeight(SerializedPropertyType.Bounds, GUIContent.none), EditorStyles.numberField, options), value);
    }
    ...
    public static Bounds BoundsField(GUIContent label, Bounds value, params GUILayoutOption[] options)
    {
      ...
      return EditorGUI.BoundsField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(hasLabel, propertyHeight, EditorStyles.numberField, options), label, value);
    }
    ...
    {
      return EditorGUI.BoundsIntField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(false, EditorGUI.GetPropertyHeight(SerializedPropertyType.BoundsInt, GUIContent.none), EditorStyles.numberField, options), value);
    }
    ...
    public static BoundsInt BoundsIntField(GUIContent label, BoundsInt value, params GUILayoutOption[] options)
    {
      ...
      return EditorGUI.BoundsIntField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(hasLabel, propertyHeight, EditorStyles.numberField, options), label, value);
    }
    ...
    {
      EditorGUILayout.CurveField(property, color, ranges, (GUIContent) null, options);
    }
    ...
    {
      EditorGUI.CurveField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(false, 16f, EditorStyles.colorField, options), property, color, ranges, label);
    }
    ...
    {
      return EditorGUI.Foldout(EditorGUILayout.s_LastRect = GUILayoutUtility.GetRect(EditorGUIUtility.fieldWidth, EditorGUIUtility.fieldWidth, 16f, 16f, style), foldout, content, toggleOnLabelClick, style);
    }
    ...
    {
      EditorGUI.LayerMaskField(EditorGUILayout.s_LastRect = EditorGUILayout.GetControlRect(true, 16f, options), layers, label, callback);
    }
    ...
    internal static void PrefixLabelInternal(GUIContent label, GUIStyle followingStyle, GUIStyle labelStyle)
    {
      ...
      {
        Rect rect = GUILayoutUtility.GetRect((float) ((double) EditorGUIUtility.labelWidth - (double) left), 16f, followingStyle, new GUILayoutOption[1]{ GUILayout.ExpandWidth(false) });
    ...
    internal static int BeginPlatformGrouping(BuildPlatform[] platforms, GUIContent defaultTab, GUIStyle style)
    {
      ...
      if (EditorGUI.EndChangeCheck())
      {
        ...
        foreach (UnityEngine.Object @object in UnityEngine.Resources.FindObjectsOfTypeAll(typeof (BuildPlayerWindow)))
        {
    ...
    internal static void MultiSelectionObjectTitleBar(UnityEngine.Object[] objects)
    {
      ...
      if (objects.Length > 1)
        t = t + " and " + (object) (objects.Length - 1) + " other" + (objects.Length <= 2 ? (object) "" : (object) "s");
      GUILayoutOption[] guiLayoutOptionArray = new GUILayoutOption[1]{ GUILayout.Height(16f) };
    ...
    {
      return EditorGUILayout.DropdownButton(content, focusType, (GUIStyle) "MiniPullDown", options);
    }
    ...
    public static Enum EnumMaskPopup(GUIContent label, Enum selected, GUIStyle style, params GUILayoutOption[] options)
    {
      int changedFlags;
      bool changedToValue;
      return EditorGUILayout.EnumMaskPopup(label, selected, out changedFlags, out changedToValue, style, options);
    }
    ...
    public static float Knob(Vector2 knobSize, float value, float minValue, float maxValue, string unit, Color backgroundColor, Color activeColor, bool showValue, params GUILayoutOption[] options)
    {
      ...
      return EditorGUI.Knob(position, knobSize, value, minValue, maxValue, unit, backgroundColor, activeColor, showValue, GUIUtility.GetControlID(nameof (Knob).GetHashCode(), FocusType.Passive, position));
    }
    ...
    internal static void TargetChoiceField(SerializedProperty property, GUIContent label, params GUILayoutOption[] options)
    {
      ...
      // ISSUE: reference to a compiler-generated field
      TargetChoiceHandler.TargetChoiceMenuFunction fMgCache0 = EditorGUILayout.\u003C\u003Ef__mg\u0024cache0;
      GUILayoutOption[] guiLayoutOptionArray = options;
      EditorGUILayout.TargetChoiceField(property1, label1, fMgCache0, guiLayoutOptionArray);
    }
    ...
    public class FadeGroupScope : GUI.Scope
    {
      ...
      protected override void CloseScope()
      {
        if ((double) this.m_Value == 0.0 || (double) this.m_Value == 1.0)
          return;
