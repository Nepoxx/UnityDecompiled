...
namespace UnityEditor
{
  internal class GameViewGUI
  {
    ...
    public static void GameViewStatsGUI()
    {
      ...
      int num3 = UnityStats.instancedBatchedDrawCalls - UnityStats.instancedBatches;
      ...
      stringBuilder2.Append(string.Format("  Batches: <b>{0}</b> \tSaved by batching: {1}\n", (object) UnityStats.batches, (object) (num1 + num2 + num3)));
      stringBuilder2.Append(string.Format("  Tris: {0} \tVerts: {1} \n", (object) GameViewGUI.FormatNumber(UnityStats.trianglesLong), (object) GameViewGUI.FormatNumber(UnityStats.verticesLong)));
