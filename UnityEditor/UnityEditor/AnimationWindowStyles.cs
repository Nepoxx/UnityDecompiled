...
namespace UnityEditor
{
  internal class AnimationWindowStyles
  {
    ...
    public static GUIStyle playHead = (GUIStyle) "AnimationPlayHead";
    public static GUIStyle curveEditorBackground = (GUIStyle) "CurveEditorBackground";
    public static GUIStyle curveEditorLabelTickmarks = (GUIStyle) "CurveEditorLabelTickmarks";
    public static GUIStyle eventBackground = (GUIStyle) "AnimationEventBackground";
    public static GUIStyle eventTooltip = (GUIStyle) "AnimationEventTooltip";
    public static GUIStyle eventTooltipArrow = (GUIStyle) "AnimationEventTooltipArrow";
    ...
    public static GUIStyle dopeSheetKeyframe = (GUIStyle) "Dopesheetkeyframe";
    public static GUIStyle dopeSheetBackground = (GUIStyle) "DopesheetBackground";
    public static GUIStyle popupCurveDropdown = (GUIStyle) "PopupCurveDropdown";
    public static GUIStyle popupCurveEditorBackground = (GUIStyle) "PopupCurveEditorBackground";
    public static GUIStyle popupCurveEditorSwatch = (GUIStyle) "PopupCurveEditorSwatch";
    public static GUIStyle popupCurveSwatchBackground = (GUIStyle) "PopupCurveSwatchBackground";
