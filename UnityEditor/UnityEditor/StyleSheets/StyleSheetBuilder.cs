...
// Type: UnityEditor.StyleSheets.StyleSheetBuilder
...
namespace UnityEditor.StyleSheets
{
  internal class StyleSheetBuilder
  {
    ...
    {
      StyleSheetBuilder.Log("Begin complex selector with specificity " + (object) specificity);
    ...
    public void AddSimpleSelector(StyleSelectorPart[] parts, StyleSelectorRelationship previousRelationsip)
    {
      ...
      StyleSheetBuilder.Log("Add simple selector " + (object) styleSelector);
    ...
    public void EndProperty()
    {
      ...
      this.m_BuilderState = StyleSheetBuilder.BuilderState.Rule;
      this.m_CurrentProperties.Add(new StyleProperty()
      {
        name = this.m_CurrentPropertyName,
        values = this.m_CurrentValues.ToArray()
      });
    ...
    {
      StyleSheetBuilder.Log("Add value of type " + (object) type + " : " + (object) value);
      list.Add(value);
