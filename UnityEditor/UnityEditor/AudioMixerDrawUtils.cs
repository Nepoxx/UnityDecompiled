...
namespace UnityEditor
{
  internal class AudioMixerDrawUtils
  {
    ...
    {
      if (effect.IsSend())
        return !((Object) effect.sendTarget != (Object) null) ? Color.gray : AudioMixerDrawUtils.kSendColor;
      if (effect.IsReceive())
    ...
    public static void DrawConnection(Color col, float mixLevel, float srcX, float srcY, float dstX, float dstY, float width)
    {
      ...
      points[3] = points[0];
      Color c = new Color(col.r, col.g, col.b, (float) ((double) mixLevel * 0.300000011920929 + 0.300000011920929));
    ...
    public class Styles
    {
      ...
      public GUIStyle channelStripAreaBackground = (GUIStyle) "CurveEditorBackground";
