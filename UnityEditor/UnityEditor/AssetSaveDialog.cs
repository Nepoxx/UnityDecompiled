...
namespace UnityEditor
{
  ...
  {
    private static AssetSaveDialog.Styles s_Styles = (AssetSaveDialog.Styles) null;
    ...
    private void OnGUI()
    {
      ...
      int num = 0;
      IEnumerator enumerator = ListViewGUILayout.ListView(this.m_LV, AssetSaveDialog.s_Styles.box).GetEnumerator();
      try
      {
        while (enumerator.MoveNext())
        {
          ...
          GUILayout.Label(this.m_Content[current.row]);
