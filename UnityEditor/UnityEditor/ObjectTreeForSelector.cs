...
namespace UnityEditor
{
  ...
  internal class ObjectTreeForSelector
  {
    ...
    public void Clear()
    {
      ...
      this.m_UserData = 0;
      this.m_TreeView = (TreeViewController) null;
    ...
    private void BottomBar(Rect bottomRect)
    {
      ...
      if (id != this.m_LastSelectedID)
      {
        ...
        this.m_SelectedPath = "";
        TreeViewItem treeViewItem1 = this.m_TreeView.FindItem(id);
        if (treeViewItem1 != null)
        {
          StringBuilder stringBuilder = new StringBuilder();
          for (TreeViewItem treeViewItem2 = treeViewItem1; treeViewItem2 != null && treeViewItem2 != this.m_TreeView.data.root; treeViewItem2 = treeViewItem2.parent)
          {
            if (treeViewItem2 != treeViewItem1)
    ...
    private void OnItemSelectionChanged(int[] selection)
    {
      ...
      if (selection.Length > 0)
        treeViewItem = this.m_TreeView.FindItem(selection[0]);
