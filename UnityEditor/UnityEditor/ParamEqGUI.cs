...
namespace UnityEditor
{
  internal class ParamEqGUI : IAudioEffectPluginGUI
  {
    ...
    private static bool ParamEqualizerCurveEditor(IAudioEffectPlugin plugin, Rect r, ref float centerFreq, ref float bandwidth, ref float gain, float blend)
    {
      ...
      ParamEqGUI.\u003CParamEqualizerCurveEditor\u003Ec__AnonStorey0 editorCAnonStorey0 = new ParamEqGUI.\u003CParamEqualizerCurveEditor\u003Ec__AnonStorey0();
      // ISSUE: reference to a compiler-generated field
      editorCAnonStorey0.plugin = plugin;
      ...
      float defaultValue1;
      // ISSUE: reference to a compiler-generated field
      editorCAnonStorey0.plugin.GetFloatParameterInfo(ParamEqGUI.kCenterFreqName, out minRange1, out maxRange1, out defaultValue1);
      float minRange2;
      float maxRange2;
      float defaultValue2;
      // ISSUE: reference to a compiler-generated field
      editorCAnonStorey0.plugin.GetFloatParameterInfo(ParamEqGUI.kOctaveRangeName, out minRange2, out maxRange2, out defaultValue2);
      float minRange3;
      float maxRange3;
      float defaultValue3;
      // ISSUE: reference to a compiler-generated field
      editorCAnonStorey0.plugin.GetFloatParameterInfo(ParamEqGUI.kFrequencyGainName, out minRange3, out maxRange3, out defaultValue3);
      bool flag = false;
      switch (current.GetTypeForControl(controlId))
      {
        ...
        case EventType.MouseDrag:
          if (GUIUtility.hotControl == controlId)
          {
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            centerFreq = Mathf.Clamp((float) ParamEqGUI.MapNormalizedFrequency(ParamEqGUI.MapNormalizedFrequency((double) centerFreq, (double) editorCAnonStorey0.plugin.GetSampleRate(), true, false) + (double) current.delta.x / (double) r.width, (double) editorCAnonStorey0.plugin.GetSampleRate(), true, true), minRange1, maxRange1);
      ...
      if (Event.current.type == EventType.Repaint)
      {
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        ParamEqGUI.\u003CParamEqualizerCurveEditor\u003Ec__AnonStorey1 editorCAnonStorey1 = new ParamEqGUI.\u003CParamEqualizerCurveEditor\u003Ec__AnonStorey1();
        // ISSUE: reference to a compiler-generated field
        editorCAnonStorey1.\u003C\u003Ef__ref\u00240 = editorCAnonStorey0;
        // ISSUE: reference to a compiler-generated field
        EditorGUI.DrawRect(new Rect((float) ParamEqGUI.MapNormalizedFrequency((double) centerFreq, (double) editorCAnonStorey0.plugin.GetSampleRate(), true, false) * r.width + r.x, r.y, 1f, r.height), GUIUtility.hotControl != controlId ? new Color(0.4f, 0.4f, 0.4f) : new Color(0.6f, 0.6f, 0.6f));
        HandleUtility.ApplyWireMaterial();
        double num1 = 3.1415926;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        editorCAnonStorey1.wm = -2.0 * num1 / (double) editorCAnonStorey0.plugin.GetSampleRate();
        // ISSUE: reference to a compiler-generated field
        double num2 = 2.0 * num1 * (double) centerFreq / (double) editorCAnonStorey0.plugin.GetSampleRate();
        double num3 = 1.0 / (double) bandwidth;
        double num4 = (double) gain;
        double num5 = Math.Sin(num2) / (2.0 * num3);
        // ISSUE: reference to a compiler-generated field
        editorCAnonStorey1.b0 = 1.0 + num5 * num4;
        // ISSUE: reference to a compiler-generated field
        editorCAnonStorey1.b1 = -2.0 * Math.Cos(num2);
        // ISSUE: reference to a compiler-generated field
        editorCAnonStorey1.b2 = 1.0 - num5 * num4;
        // ISSUE: reference to a compiler-generated field
        editorCAnonStorey1.a0 = 1.0 + num5 / num4;
        // ISSUE: reference to a compiler-generated field
        editorCAnonStorey1.a1 = -2.0 * Math.Cos(num2);
        // ISSUE: reference to a compiler-generated field
        editorCAnonStorey1.a2 = 1.0 - num5 / num4;
        // ISSUE: reference to a compiler-generated method
        AudioCurveRendering.DrawCurve(r, new AudioCurveRendering.AudioCurveEvaluator(editorCAnonStorey1.\u003C\u003Em__0), ParamEqGUI.ScaleAlpha(AudioCurveRendering.kAudioOrange, blend));
      }
      // ISSUE: reference to a compiler-generated field
      ParamEqGUI.DrawFrequencyTickMarks(r, (float) editorCAnonStorey0.plugin.GetSampleRate(), true, new Color(1f, 1f, 1f, 0.3f * blend));
    ...
    public override bool OnGUI(IAudioEffectPlugin plugin)
    {
      ...
      GUILayout.Space(5f);
      Rect rect = GUILayoutUtility.GetRect(200f, 100f, new GUILayoutOption[1]{ GUILayout.ExpandWidth(true) });
