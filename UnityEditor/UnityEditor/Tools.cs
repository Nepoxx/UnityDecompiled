...
namespace UnityEditor
{
  ...
  public sealed class Tools : ScriptableObject
  {
      ...
      get
      {
        ...
        if (current != null && Tools.viewToolActive)
        {
          if (Tools.s_LockedViewTool == ViewTool.None)
          {
            ...
            if (Tools.s_ButtonDown <= 0 && flag2 || Tools.s_ButtonDown <= 0 && actionKey || Tools.s_ButtonDown == 2 || (Object) SceneView.lastActiveSceneView != (Object) null && (SceneView.lastActiveSceneView.in2DMode || SceneView.lastActiveSceneView.isRotationLocked) && ((Tools.s_ButtonDown != 1 || !current.alt) && (Tools.s_ButtonDown > 0 || !flag1)))
    ...
    internal static bool viewToolActive
    {
      get
      {
        if (GUIUtility.hotControl != 0 && Tools.s_LockedViewTool == ViewTool.None)
          return false;
        return Tools.s_LockedViewTool != ViewTool.None || Tools.current == Tool.View || (Event.current.alt || Tools.s_ButtonDown == 1) || Tools.s_ButtonDown == 2;
      }
    }
    ...
    {
      Tools.s_Get = this;
      EditorApplication.CallbackFunction globalEventHandler = EditorApplication.globalEventHandler;
      ...
      // ISSUE: reference to a compiler-generated field
      EditorApplication.CallbackFunction fMgCache0 = Tools.\u003C\u003Ef__mg\u0024cache0;
      EditorApplication.globalEventHandler = globalEventHandler + fMgCache0;
    ...
    private void OnDisable()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      EditorApplication.CallbackFunction fMgCache1 = Tools.\u003C\u003Ef__mg\u0024cache1;
      EditorApplication.globalEventHandler = globalEventHandler - fMgCache1;
    }
