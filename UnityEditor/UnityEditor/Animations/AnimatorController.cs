...
namespace UnityEditor.Animations
{
  ...
  {
    internal static AnimatorController lastActiveController = (AnimatorController) null;
    ...
    /// </summary>
    public extern AnimatorControllerLayer[] layers { [GeneratedByOldBindingsGenerator, MethodImpl(MethodImplOptions.InternalCall)] get; [GeneratedByOldBindingsGenerator, MethodImpl(MethodImplOptions.InternalCall)] set; }
    ...
    /// </summary>
    public extern UnityEngine.AnimatorControllerParameter[] parameters { [GeneratedByOldBindingsGenerator, MethodImpl(MethodImplOptions.InternalCall)] get; [GeneratedByOldBindingsGenerator, MethodImpl(MethodImplOptions.InternalCall)] set; }
    ...
    internal static AnimatorControllerPlayable FindAnimatorControllerPlayable(Animator animator, AnimatorController controller)
    {
      ...
      AnimatorController.FindAnimatorControllerPlayableInternal(ref ret, animator, controller);
      if (!ret.IsValid())
        return AnimatorControllerPlayable.Null;
      return new AnimatorControllerPlayable(ret);
    }
    ...
    internal extern bool isAssetBundled { [GeneratedByOldBindingsGenerator, MethodImpl(MethodImplOptions.InternalCall)] get; }
    ...
    internal void RemoveLayers(List<int> layerIndexes)
    {
      ...
      foreach (int layerIndex in layerIndexes)
        this.RemoveLayerInternal(layerIndex, ref layers);
      this.layers = layers;
    }
