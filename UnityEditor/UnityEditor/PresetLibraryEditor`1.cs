  ...
  internal class PresetLibraryEditor<T> where T : PresetLibrary
  {
    ...
    private void CreateNewPresetButton(Rect buttonRect, object newPresetObject, PresetLibrary lib, bool isOpenForEdit)
    {
      using (new EditorGUI.DisabledScope(!isOpenForEdit))
      {
        ...
        {
          int newPreset = this.CreateNewPreset(newPresetObject, "");
          if (this.drawLabels)
            this.BeginRenaming("", newPreset, 0.0f);
    ...
    private class SettingsMenu
    {
      ...
      public static void Show(Rect activatorRect, PresetLibraryEditor<T> owner)
      {
        ...
        {
          bool flag = PresetLibraryEditor<T>.SettingsMenu.s_Owner.itemViewMode == viewModeDataList[index].viewmode && (int) PresetLibraryEditor<T>.SettingsMenu.s_Owner.previewHeight == viewModeDataList[index].itemHeight;
          GenericMenu genericMenu2 = genericMenu1;
          GUIContent text = viewModeDataList[index].text;
          int num = flag ? 1 : 0;
          ...
          // ISSUE: reference to a compiler-generated field
          GenericMenu.MenuFunction2 fMgCache0 = PresetLibraryEditor<T>.SettingsMenu.\u003C\u003Ef__mg\u0024cache0;
          PresetLibraryEditor<T>.SettingsMenu.ViewModeData viewModeData = viewModeDataList[index];
          genericMenu2.AddItem(text, num != 0, fMgCache0, (object) viewModeData);
        }
        ...
        string str2 = " (Project)";
        foreach (string path in preferencesLibs)
        {
          string withoutExtension = Path.GetFileNameWithoutExtension(path);
          GenericMenu genericMenu2 = genericMenu1;
          GUIContent content = new GUIContent(withoutExtension);
          int num = str1 == path ? 1 : 0;
          // ISSUE: reference to a compiler-generated field
          ...
          // ISSUE: reference to a compiler-generated field
          GenericMenu.MenuFunction2 fMgCache1 = PresetLibraryEditor<T>.SettingsMenu.\u003C\u003Ef__mg\u0024cache1;
          string str3 = path;
          genericMenu2.AddItem(content, num != 0, fMgCache1, (object) str3);
        }
        foreach (string path in projectLibs)
        {
          string withoutExtension = Path.GetFileNameWithoutExtension(path);
          GenericMenu genericMenu2 = genericMenu1;
          GUIContent content = new GUIContent(withoutExtension + str2);
          int num = str1 == path ? 1 : 0;
          // ISSUE: reference to a compiler-generated field
          ...
          // ISSUE: reference to a compiler-generated field
          GenericMenu.MenuFunction2 fMgCache2 = PresetLibraryEditor<T>.SettingsMenu.\u003C\u003Ef__mg\u0024cache2;
          string str3 = path;
          genericMenu2.AddItem(content, num != 0, fMgCache2, (object) str3);
        }
        genericMenu1.AddSeparator("");
        GenericMenu genericMenu3 = genericMenu1;
        GUIContent content1 = new GUIContent("Create New Library...");
        int num1 = 0;
        // ISSUE: reference to a compiler-generated field
        ...
        // ISSUE: reference to a compiler-generated field
        GenericMenu.MenuFunction2 fMgCache3 = PresetLibraryEditor<T>.SettingsMenu.\u003C\u003Ef__mg\u0024cache3;
        // ISSUE: variable of a boxed type
        __Boxed<int> local1 = (ValueType) 0;
        genericMenu3.AddItem(content1, num1 != 0, fMgCache3, (object) local1);
        if (PresetLibraryEditor<T>.SettingsMenu.HasDefaultPresets())
        {
          genericMenu1.AddSeparator("");
          GenericMenu genericMenu2 = genericMenu1;
          GUIContent content2 = new GUIContent("Add Factory Presets To Current Library");
          int num2 = 0;
          // ISSUE: reference to a compiler-generated field
          ...
          // ISSUE: reference to a compiler-generated field
          GenericMenu.MenuFunction2 fMgCache4 = PresetLibraryEditor<T>.SettingsMenu.\u003C\u003Ef__mg\u0024cache4;
          // ISSUE: variable of a boxed type
          __Boxed<int> local2 = (ValueType) 0;
          genericMenu2.AddItem(content2, num2 != 0, fMgCache4, (object) local2);
        }
        genericMenu1.AddSeparator("");
        GenericMenu genericMenu4 = genericMenu1;
        GUIContent content3 = new GUIContent("Reveal Current Library Location");
        int num3 = 0;
        // ISSUE: reference to a compiler-generated field
        ...
        // ISSUE: reference to a compiler-generated field
        GenericMenu.MenuFunction2 fMgCache5 = PresetLibraryEditor<T>.SettingsMenu.\u003C\u003Ef__mg\u0024cache5;
        // ISSUE: variable of a boxed type
        __Boxed<int> local3 = (ValueType) 0;
        genericMenu4.AddItem(content3, num3 != 0, fMgCache5, (object) local3);
