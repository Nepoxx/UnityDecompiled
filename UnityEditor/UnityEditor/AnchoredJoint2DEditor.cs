  ...
  internal class AnchoredJoint2DEditor : Joint2DEditor
  {
    ...
    public void OnSceneGUI()
    {
      ...
      if (!this.HandleAnchor(ref position1, false))
        return;
      position1 = this.SnapToSprites(position1);
      position1 = Joint2DEditor.SnapToPoint(position1, position2, 0.13f);
      Undo.RecordObject((Object) this.anchorJoint2D, "Move Anchor");
      this.anchorJoint2D.anchor = (Vector2) Joint2DEditor.InverseTransformPoint(this.anchorJoint2D.transform, position1);
    }
