...
namespace UnityEditor
{
  ...
  public sealed class GenericMenu
  {
    ...
    public void DropDown(Rect position)
    {
      ...
      EditorUtility.DisplayCustomMenuWithSeparators(position, options, enabled, separator, (int[]) arrayList.ToArray(typeof (int)), new EditorUtility.SelectMenuItemFunction(this.CatchMenu), (object) null, true);
    }
