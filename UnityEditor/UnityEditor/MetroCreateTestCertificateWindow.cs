...
namespace UnityEditor
{
  internal class MetroCreateTestCertificateWindow : EditorWindow
  {
    ...
    {
      MetroCreateTestCertificateWindow[] objectsOfTypeAll = (MetroCreateTestCertificateWindow[]) UnityEngine.Resources.FindObjectsOfTypeAll(typeof (MetroCreateTestCertificateWindow));
      ...
      certificateWindow.focus = nameof (publisher);
