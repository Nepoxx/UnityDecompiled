...
namespace UnityEditor
{
  ...
  internal class ScriptExecutionOrderInspector : Editor
  {
    ...
    private MonoScript m_Edited = (MonoScript) null;
    ...
    {
      foreach (ScriptExecutionOrderInspector instance in ScriptExecutionOrderInspector.GetInstances())
      {
        for (int index = 0; index < instance.m_AllOrders.Length; ++index)
          instance.m_AllOrders[index] = 0;
        instance.Apply();
      }
    }
    ...
    private static UnityEngine.Object MonoScriptValidatorCallback(UnityEngine.Object[] references, System.Type objType, SerializedProperty property, EditorGUI.ObjectFieldValidatorOptions options)
    {
    ...
    private void Apply()
    {
      ...
      if (flag)
      {
        foreach (int index in intList)
          MonoImporter.SetExecutionOrder(this.m_AllScripts[index], this.m_AllOrders[index]);
        this.PopulateScriptArray();
      }
      else
    ...
    public override void OnInspectorGUI()
    {
      ...
      EditorGUILayout.Space();
      Rect position1 = EditorGUILayout.BeginVertical();
      int controlId = GUIUtility.GetControlID(ScriptExecutionOrderInspector.s_DropFieldHash, FocusType.Passive, position1);
      ...
      // ISSUE: reference to a compiler-generated field
      EditorGUI.ObjectFieldValidator fMgCache0 = ScriptExecutionOrderInspector.\u003C\u003Ef__mg\u0024cache0;
      int num = 0;
      GUIStyle dropField = ScriptExecutionOrderInspector.m_Styles.dropField;
      MonoScript script = EditorGUI.DoDropField(position2, id, objType, fMgCache0, num != 0, dropField) as MonoScript;
      ...
      if (EditorGUI.DropdownButton(rect, iconToolbarPlus, FocusType.Passive, ScriptExecutionOrderInspector.m_Styles.toolbarDropDown))
    ...
    public void DrawElement(Rect r, object obj, bool dragging)
    {
      ...
      int controlId = GUIUtility.GetControlID(script.GetHashCode(), FocusType.Keyboard, fieldRect);
    ...
    public class SortMonoScriptNameOrder : IComparer<MonoScript>
    {
      public virtual int Compare(MonoScript x, MonoScript y)
      {
        if (!((UnityEngine.Object) x != (UnityEngine.Object) null) || !((UnityEngine.Object) y != (UnityEngine.Object) null))
          return -1;
        System.Type type1 = x.GetClass();
        System.Type type2 = y.GetClass();
    ...
    {
      private static int s_DragReorderGUIHash = nameof (DragReorderGUI).GetHashCode();
