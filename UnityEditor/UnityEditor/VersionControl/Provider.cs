...
namespace UnityEditor.VersionControl
{
  ...
  public sealed class Provider
  {
    ...
    /// </summary>
    public static extern bool isActive { [GeneratedByOldBindingsGenerator, MethodImpl(MethodImplOptions.InternalCall)] get; }
    ...
    /// </summary>
    public static extern bool requiresNetwork { [GeneratedByOldBindingsGenerator, MethodImpl(MethodImplOptions.InternalCall)] get; }

    public static extern bool hasChangelistSupport { [GeneratedByOldBindingsGenerator, MethodImpl(MethodImplOptions.InternalCall)] get; }

    public static extern bool hasCheckoutSupport { [GeneratedByOldBindingsGenerator, MethodImpl(MethodImplOptions.InternalCall)] get; }

    public static extern bool isVersioningFolders { [GeneratedByOldBindingsGenerator, MethodImpl(MethodImplOptions.InternalCall)] get; }

    /// <summary>
    ///   <para>Returns the OnlineState of the version control provider.</para>
    /// </summary>
    public static extern OnlineState onlineState { [GeneratedByOldBindingsGenerator, MethodImpl(MethodImplOptions.InternalCall)] get; }

    /// <summary>
    ///   <para>Returns the reason for the version control provider being offline (if it is offline).</para>
    /// </summary>
    public static extern string offlineReason { [GeneratedByOldBindingsGenerator, MethodImpl(MethodImplOptions.InternalCall)] get; }

    /// <summary>
    ///   <para>Gets the currently executing task.</para>
    /// </summary>
    public static extern Task activeTask { [GeneratedByOldBindingsGenerator, MethodImpl(MethodImplOptions.InternalCall)] get; }

    internal static extern Texture2D overlayAtlas { [GeneratedByOldBindingsGenerator, MethodImpl(MethodImplOptions.InternalCall)] get; }
    ...
    internal static extern CustomCommand[] customCommands { [GeneratedByOldBindingsGenerator, MethodImpl(MethodImplOptions.InternalCall)] get; }
    ...
    {
      return Provider.Internal_Status(new Asset[1]{ asset }, true);
    }
    ...
    {
      return Provider.Internal_Status(new Asset[1]{ asset }, recursively);
    }
    ...
    {
      return Provider.Internal_StatusStrings(new string[1]{ asset }, true);
    }
    ...
    {
      return Provider.Internal_StatusStrings(new string[1]{ asset }, recursively);
    }
    ...
    {
      return Provider.Internal_Add(new Asset[1]{ asset }, recursive);
    }
    ...
    {
      return Provider.Internal_Lock(new Asset[1]{ asset }, locked);
    }
    ...
    {
      return Provider.Internal_ChangeSetStatus(new ChangeSet("", changesetID));
    }
    ...
    {
      return Provider.Internal_IncomingChangeSetAssets(new ChangeSet("", changesetID));
    }
