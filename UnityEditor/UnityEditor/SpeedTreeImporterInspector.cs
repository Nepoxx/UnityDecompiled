...
namespace UnityEditor
{
  ...
  internal class SpeedTreeImporterInspector : AssetImporterEditor
  {
    ...
    protected override bool OnApplyRevertGUI()
    {
      ...
      {
        this.RevertButton();
        flag1 = this.ApplyButton("Apply Prefab");
      }
    ...
    internal List<LODGroupGUI.LODInfo> GetLODInfoArray(Rect area)
    {
      ...
      SpeedTreeImporterInspector.\u003CGetLODInfoArray\u003Ec__AnonStorey0 arrayCAnonStorey0 = new SpeedTreeImporterInspector.\u003CGetLODInfoArray\u003Ec__AnonStorey0();
      // ISSUE: reference to a compiler-generated field
      arrayCAnonStorey0.\u0024this = this;
      // ISSUE: reference to a compiler-generated field
      arrayCAnonStorey0.lodCount = this.m_LODSettings.arraySize;
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
      // ISSUE: reference to a compiler-generated method
      return LODGroupGUI.CreateLODInfos(arrayCAnonStorey0.lodCount, area, new Func<int, string>(arrayCAnonStorey0.\u003C\u003Em__0), new Func<int, float>(arrayCAnonStorey0.\u003C\u003Em__1));
    }
    ...
    {
      return !this.serializedObject.FindProperty("m_HasBillboard").hasMultipleDifferentValues && !this.m_LODSettings.FindPropertyRelative("Array.size").hasMultipleDifferentValues;
    }
      ...
      switch (current.GetTypeForControl(controlId))
      {
        case EventType.MouseDown:
          ...
          foreach (LODGroupGUI.LODInfo lodInfo in lodInfoList)
          {
            if (lodInfo.m_ButtonPosition.Contains(current.mousePosition))
            {
              ...
              this.m_SelectedLODRange = lodInfo.LODLevel;
              flag = true;
              break;
            }
          }
        ...
        case EventType.MouseDrag:
          if (GUIUtility.hotControl != controlId || this.m_SelectedLODSlider < 0 || lods[this.m_SelectedLODSlider] == null)
            break;
          current.Use();
          LODGroupGUI.SetSelectedLODLevelPercentage(LODGroupGUI.GetCameraPercent(current.mousePosition, sliderPosition) - 1f / 1000f, this.m_SelectedLODSlider, lods);
