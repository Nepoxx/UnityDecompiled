...
// Type: UnityEditor.WaveformStreamer
...
namespace UnityEditor
{
  ...
  internal sealed class WaveformStreamer
  {
    ...
    {
      this.m_Data = WaveformStreamer.Internal_WaveformStreamerCreateUntyped((object) this, clip, start, duration, numOutputSamples, onNewWaveformData);
    }
    ...
    {
      return (object) new WaveformStreamer(clip, start, duration, numOutputSamples, onNewWaveformData);
    }
