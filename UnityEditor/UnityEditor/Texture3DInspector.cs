...
namespace UnityEditor
{
  ...
  internal class Texture3DInspector : TextureInspector
  {
    ...
    public override string GetInfoString()
    {
      ...
      return string.Format("{0}x{1}x{2} {3} {4}", (object) target.width, (object) target.height, (object) target.depth, (object) TextureUtil.GetTextureFormatString(target.format), (object) EditorUtility.FormatBytes(TextureUtil.GetRuntimeMemorySizeLong((Texture) target)));
    }
