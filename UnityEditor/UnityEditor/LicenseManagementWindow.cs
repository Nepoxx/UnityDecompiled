...
namespace UnityEditor
{
  internal sealed class LicenseManagementWindow : EditorWindow
  {
    ...
    private void OnGUI()
    {
      ...
      if (GUILayout.Button("Check for updates", new GUILayoutOption[2]{ GUILayout.ExpandHeight(true), GUILayout.Width((float) LicenseManagementWindow.buttonWidth) }))
      ...
      GUILayout.Space(15f);
      GUILayout.BeginHorizontal();
      if (GUILayout.Button("Activate new license", new GUILayoutOption[2]{ GUILayout.ExpandHeight(true), GUILayout.Width((float) LicenseManagementWindow.buttonWidth) }))
      {
      ...
      GUILayout.Space(15f);
      GUILayout.BeginHorizontal();
      if (GUILayout.Button("Return license", new GUILayoutOption[2]{ GUILayout.ExpandHeight(true), GUILayout.Width((float) LicenseManagementWindow.buttonWidth) }))
      ...
      GUILayout.Space(15f);
      GUILayout.BeginHorizontal();
      if (GUILayout.Button("Manual activation", new GUILayoutOption[2]{ GUILayout.ExpandHeight(true), GUILayout.Width((float) LicenseManagementWindow.buttonWidth) }))
      ...
      GUILayout.Space(15f);
      GUILayout.BeginHorizontal();
      if (GUILayout.Button("Unity FAQ", new GUILayoutOption[2]{ GUILayout.ExpandHeight(true), GUILayout.Width((float) LicenseManagementWindow.buttonWidth) }))
