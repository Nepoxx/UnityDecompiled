  ...
  public class Dropdown : Selectable, IPointerClickHandler, ISubmitHandler, ICancelHandler, IEventSystemHandler
  {
    ...
    public int value
    {
      ...
      set
      {
        ...
        this.RefreshShownValue();
        UISystemProfilerApi.AddMarker("Dropdown.value", (UnityEngine.Object) this);
    ...
    public void Show()
    {
      ...
      for (int index = 0; index < this.options.Count; ++index)
      {
        ...
        Dropdown.\u003CShow\u003Ec__AnonStorey1 showCAnonStorey1 = new Dropdown.\u003CShow\u003Ec__AnonStorey1();
        // ISSUE: reference to a compiler-generated field
        showCAnonStorey1.\u0024this = this;
        Dropdown.OptionData option = this.options[index];
        // ISSUE: reference to a compiler-generated field
        showCAnonStorey1.item = this.AddItem(option, this.value == index, componentInChildren, this.m_Items);
        // ISSUE: reference to a compiler-generated field
        if (!((UnityEngine.Object) showCAnonStorey1.item == (UnityEngine.Object) null))
        {
          // ISSUE: reference to a compiler-generated field
          showCAnonStorey1.item.toggle.isOn = this.value == index;
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
          showCAnonStorey1.item.toggle.onValueChanged.AddListener(new UnityAction<bool>(showCAnonStorey1.\u003C\u003Em__0));
          // ISSUE: reference to a compiler-generated field
          if (showCAnonStorey1.item.toggle.isOn)
          {
            // ISSUE: reference to a compiler-generated field
            showCAnonStorey1.item.toggle.Select();
          }
          if ((UnityEngine.Object) toggle != (UnityEngine.Object) null)
          {
            Navigation navigation1 = toggle.navigation;
            // ISSUE: reference to a compiler-generated field
            Navigation navigation2 = showCAnonStorey1.item.toggle.navigation;
            navigation1.mode = Navigation.Mode.Explicit;
            navigation2.mode = Navigation.Mode.Explicit;
            // ISSUE: reference to a compiler-generated field
            navigation1.selectOnDown = (Selectable) showCAnonStorey1.item.toggle;
            // ISSUE: reference to a compiler-generated field
            navigation1.selectOnRight = (Selectable) showCAnonStorey1.item.toggle;
            navigation2.selectOnLeft = (Selectable) toggle;
            navigation2.selectOnUp = (Selectable) toggle;
            toggle.navigation = navigation1;
            // ISSUE: reference to a compiler-generated field
            showCAnonStorey1.item.toggle.navigation = navigation2;
          }
          // ISSUE: reference to a compiler-generated field
          toggle = showCAnonStorey1.item.toggle;
        }
      }
    ...
    private Dropdown.DropdownItem AddItem(Dropdown.OptionData data, bool selected, Dropdown.DropdownItem itemTemplate, List<Dropdown.DropdownItem> items)
    {
      ...
      dropdownItem.gameObject.name = "Item " + (object) items.Count + (data.text == null ? (object) "" : (object) (": " + data.text));
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new Dropdown.\u003CDelayedDestroyDropdownList\u003Ec__Iterator0() { delay = delay, \u0024this = this };
    }
