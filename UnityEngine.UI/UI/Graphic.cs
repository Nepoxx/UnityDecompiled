...
namespace UnityEngine.UI
{
  ...
  public abstract class Graphic : UIBehaviour, ICanvasElement
  {
    ...
    public virtual Material material
    {
      get
      {
        return !((UnityEngine.Object) this.m_Material != (UnityEngine.Object) null) ? this.defaultMaterial : this.m_Material;
      }
      set
      {
    ...
    {
      if (!(bool) ((UnityEngine.Object) this.canvas) || this.canvas.renderMode == RenderMode.WorldSpace || ((double) this.canvas.scaleFactor == 0.0 || !this.canvas.pixelPerfect))
        return point;
    ...
    {
      if ((UnityEngine.Object) this.canvasRenderer == (UnityEngine.Object) null || !useRGB && !useAlpha)
        return;
      if (this.canvasRenderer.GetColor().Equals((object) targetColor))
      {
