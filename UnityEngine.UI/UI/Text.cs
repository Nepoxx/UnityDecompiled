...
namespace UnityEngine.UI
{
  ...
  {
    protected static Material s_DefaultText = (Material) null;
    [SerializeField]
    ...
    {
      if (!(bool) ((UnityEngine.Object) this) || this.m_DisableFontTextureRebuiltCallback)
        return;
    ...
    public virtual float preferredHeight
    {
      get
      {
        return this.cachedTextGeneratorForLayout.GetPreferredHeight(this.m_Text, this.GetGenerationSettings(new Vector2(this.GetPixelAdjustedRect().size.x, 0.0f))) / this.pixelsPerUnit;
      }
    }
