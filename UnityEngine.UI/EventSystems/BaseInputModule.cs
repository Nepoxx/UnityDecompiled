...
namespace UnityEngine.EventSystems
{
  ...
  public abstract class BaseInputModule : UIBehaviour
  {
    ...
    public BaseInput input
    {
      get
      {
        if ((UnityEngine.Object) this.m_InputOverride != (UnityEngine.Object) null)
          return this.m_InputOverride;
        if ((UnityEngine.Object) this.m_DefaultInput == (UnityEngine.Object) null)
        {
          foreach (BaseInput component in this.GetComponents<BaseInput>())
          {
            if ((UnityEngine.Object) component != (UnityEngine.Object) null && component.GetType() == typeof (BaseInput))
            {
              this.m_DefaultInput = component;
              break;
            }
          }
          if ((UnityEngine.Object) this.m_DefaultInput == (UnityEngine.Object) null)
            this.m_DefaultInput = this.gameObject.AddComponent<BaseInput>();
        }
