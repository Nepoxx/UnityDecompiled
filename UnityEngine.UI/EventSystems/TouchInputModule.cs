...
namespace UnityEngine.EventSystems
{
  ...
  public class TouchInputModule : PointerInputModule
  {
    ...
    {
      return this.forceModuleActive || this.input.touchSupported;
    }
    ...
    public override bool ShouldActivateModule()
    {
      ...
      if (this.UseFakeInput())
        return this.input.GetMouseButtonDown(0) | (double) (this.m_MousePosition - this.m_LastMousePosition).sqrMagnitude > 0.0;
      return this.input.touchCount > 0;
    }

    private bool UseFakeInput()
    {
      return !this.input.touchSupported;
    }
