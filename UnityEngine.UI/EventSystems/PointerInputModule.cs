...
namespace UnityEngine.EventSystems
{
  ...
  public abstract class PointerInputModule : BaseInputModule
  {
    ...
    {
      bool mouseButtonDown = this.input.GetMouseButtonDown(buttonId);
      bool mouseButtonUp = this.input.GetMouseButtonUp(buttonId);
    ...
    {
      GameObject newEnterTarget = Cursor.lockState != CursorLockMode.Locked ? pointerEvent.pointerCurrentRaycast.gameObject : (GameObject) null;
    ...
    {
      if (!pointerEvent.IsPointerMoving() || Cursor.lockState == CursorLockMode.Locked || (Object) pointerEvent.pointerDrag == (Object) null)
        return;
      if (!pointerEvent.dragging && PointerInputModule.ShouldStartDrag(pointerEvent.pressPosition, pointerEvent.position, (float) this.eventSystem.pixelDragThreshold, pointerEvent.useDragThreshold))
      {
