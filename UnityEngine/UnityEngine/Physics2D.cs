...
namespace UnityEngine
{
  public class Physics2D
  {
    ...
    public static ColliderDistance2D Distance([Writable] Collider2D colliderA, [Writable] Collider2D colliderB)
    {
      ...
      if ((Object) colliderA == (Object) colliderB)
    ...
    public static RaycastHit2D Linecast(Vector2 start, Vector2 end, [DefaultValue("DefaultRaycastLayers")] int layerMask, [DefaultValue("-Mathf.Infinity")] float minDepth, [DefaultValue("Mathf.Infinity")] float maxDepth)
    {
      ...
      Physics2D.Internal_Linecast(start, end, legacyFilter, out raycastHit);
      return raycastHit;
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_LinecastAll(start, end, legacyFilter);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_LinecastNonAlloc(start, end, legacyFilter, results);
    }
    ...
    public static RaycastHit2D Raycast(Vector2 origin, Vector2 direction, [DefaultValue("Mathf.Infinity")] float distance, [DefaultValue("DefaultRaycastLayers")] int layerMask, [DefaultValue("-Mathf.Infinity")] float minDepth, [DefaultValue("Mathf.Infinity")] float maxDepth)
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      RaycastHit2D raycastHit;
      Physics2D.Internal_Raycast(origin, direction, distance, legacyFilter, out raycastHit);
      return raycastHit;
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_RaycastAll(origin, direction, distance, legacyFilter);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_RaycastNonAlloc(origin, direction, distance, legacyFilter, results);
    }
    ...
    public static RaycastHit2D CircleCast(Vector2 origin, float radius, Vector2 direction, [DefaultValue("Mathf.Infinity")] float distance, [DefaultValue("DefaultRaycastLayers")] int layerMask, [DefaultValue("-Mathf.Infinity")] float minDepth, [DefaultValue("Mathf.Infinity")] float maxDepth)
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      RaycastHit2D raycastHit;
      Physics2D.Internal_CircleCast(origin, radius, direction, distance, legacyFilter, out raycastHit);
      return raycastHit;
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_CircleCastAll(origin, radius, direction, distance, legacyFilter);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_CircleCastNonAlloc(origin, radius, direction, distance, legacyFilter, results);
    }
    ...
    public static RaycastHit2D BoxCast(Vector2 origin, Vector2 size, float angle, Vector2 direction, [DefaultValue("Mathf.Infinity")] float distance, [DefaultValue("DefaultRaycastLayers")] int layerMask, [DefaultValue("-Mathf.Infinity")] float minDepth, [DefaultValue("Mathf.Infinity")] float maxDepth)
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      RaycastHit2D raycastHit;
      Physics2D.Internal_BoxCast(origin, size, angle, direction, distance, legacyFilter, out raycastHit);
      return raycastHit;
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_BoxCastAll(origin, size, angle, direction, distance, legacyFilter);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_BoxCastNonAlloc(origin, size, angle, direction, distance, legacyFilter, results);
    }
    ...
    public static RaycastHit2D CapsuleCast(Vector2 origin, Vector2 size, CapsuleDirection2D capsuleDirection, float angle, Vector2 direction, [DefaultValue("Mathf.Infinity")] float distance, [DefaultValue("DefaultRaycastLayers")] int layerMask, [DefaultValue("-Mathf.Infinity")] float minDepth, [DefaultValue("Mathf.Infinity")] float maxDepth)
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      RaycastHit2D raycastHit;
      Physics2D.Internal_CapsuleCast(origin, size, capsuleDirection, angle, direction, distance, legacyFilter, out raycastHit);
      return raycastHit;
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_CapsuleCastAll(origin, size, capsuleDirection, angle, direction, distance, legacyFilter);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_CapsuleCastNonAlloc(origin, size, capsuleDirection, angle, direction, distance, legacyFilter, results);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_OverlapPoint(point, legacyFilter);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_OverlapPointAll(point, legacyFilter);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_OverlapPointNonAlloc(point, legacyFilter, results);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_OverlapCircle(point, radius, legacyFilter);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_OverlapCircleAll(point, radius, legacyFilter);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_OverlapCircleNonAlloc(point, radius, legacyFilter, results);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_OverlapBox(point, size, angle, legacyFilter);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_OverlapBoxAll(point, size, angle, legacyFilter);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_OverlapBoxNonAlloc(point, size, angle, legacyFilter, results);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_OverlapArea(pointA, pointB, legacyFilter);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_OverlapAreaAll(pointA, pointB, legacyFilter);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_OverlapAreaNonAlloc(pointA, pointB, legacyFilter, results);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_OverlapCapsule(point, size, direction, angle, legacyFilter);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_OverlapCapsuleAll(point, size, direction, angle, legacyFilter);
    }
    ...
    {
      ContactFilter2D legacyFilter = ContactFilter2D.CreateLegacyFilter(layerMask, minDepth, maxDepth);
      return Physics2D.Internal_OverlapCapsuleNonAlloc(point, size, direction, angle, legacyFilter, results);
    }
    ...
    {
      return Physics2D.GetColliderContacts(collider, new ContactFilter2D().NoFilter(), contacts);
    }
    ...
    {
      return Physics2D.GetColliderContactsCollidersOnly(collider, new ContactFilter2D().NoFilter(), colliders);
    }
    ...
    {
      return Physics2D.GetRigidbodyContacts(rigidbody, new ContactFilter2D().NoFilter(), contacts);
    }
    ...
    {
      return Physics2D.GetRigidbodyContactsCollidersOnly(rigidbody, new ContactFilter2D().NoFilter(), colliders);
    }
