...
// Type: UnityEngine.CSSLayout.CSSNode
...
namespace UnityEngine.CSSLayout
{
  internal class CSSNode : IEnumerable<CSSNode>, IEnumerable
  {
    ...
    public void Reset()
    {
      this._measureFunction = (MeasureFunction) null;
    ...
    public CSSNode Parent
    {
      get
      {
        return this._parent == null ? (CSSNode) null : this._parent.Target as CSSNode;
      }
    }
    ...
    public bool ValuesEqual(float f1, float f2)
    {
      ...
      return (double) Math.Abs(f2 - f1) < 1.40129846432482E-45;
    }
    ...
    public void Insert(int index, CSSNode node)
    {
      ...
      node._parent = new WeakReference((object) this);
      Native.CSSNodeInsertChild(this._cssNode, node._cssNode, (uint) index);
    }

    public void RemoveAt(int index)
    {
      CSSNode child = this._children[index];
      child._parent = (WeakReference) null;
      this._children.RemoveAt(index);
      Native.CSSNodeRemoveChild(this._cssNode, child._cssNode);
    }
    ...
    public void SetMeasureFunction(MeasureFunction measureFunction)
    {
      ...
      this._cssMeasureFunc = measureFunction == null ? (CSSMeasureFunc) null : new CSSMeasureFunc(this.MeasureInternal);
    ...
    private CSSSize MeasureInternal(IntPtr node, float width, CSSMeasureMode widthMode, float height, CSSMeasureMode heightMode)
    {
      ...
      return new CSSSize() { width = (float) MeasureOutput.GetWidth(measureOutput), height = (float) MeasureOutput.GetHeight(measureOutput) };
    }

    public string Print()
    {
      return this.Print(CSSPrintOptions.Layout | CSSPrintOptions.Style | CSSPrintOptions.Children);
    }
    ...
    public string Print(CSSPrintOptions options)
    {
      ...
      CSSNode.\u003CPrint\u003Ec__AnonStorey0 printCAnonStorey0 = new CSSNode.\u003CPrint\u003Ec__AnonStorey0();
      // ISSUE: reference to a compiler-generated field
      printCAnonStorey0.sb = new StringBuilder();
      CSSLogger.Func logger = CSSLogger.Logger;
      // ISSUE: reference to a compiler-generated method
      CSSLogger.Logger = new CSSLogger.Func(printCAnonStorey0.\u003C\u003Em__0);
      Native.CSSNodePrint(this._cssNode, options);
      CSSLogger.Logger = logger;
      // ISSUE: reference to a compiler-generated field
      return printCAnonStorey0.sb.ToString();
    }
    ...
    {
      return this._children == null ? (IEnumerator) Enumerable.Empty<CSSNode>().GetEnumerator() : (IEnumerator) ((IEnumerable<CSSNode>) this._children).GetEnumerator();
    }
