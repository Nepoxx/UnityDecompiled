  ...
  internal sealed class _AndroidJNIHelper
  {
    ...
    public static jvalue[] CreateJNIArgArray(object[] args)
    {
      ...
      foreach (object obj in args)
      {
        ...
        {
          jvalueArray[index].l = ((AndroidJavaProxy) obj).GetProxy().GetRawObject();
        }
        else
        {
    ...
    public static string GetSignature(object obj)
    {
      ...
      if (AndroidReflection.IsPrimitive(type))
      {
        ...
        if (type.Equals(typeof (double)))
          return "D";
        return type.Equals(typeof (char)) ? "C" : "";
      }
      ...
      else
      {
        ...
        throw new Exception("JNI: Unknown signature for type '" + (object) type + "' (obj = " + obj + ") " + (type != obj ? (object) "instance" : (object) "equal"));
      }
    }
