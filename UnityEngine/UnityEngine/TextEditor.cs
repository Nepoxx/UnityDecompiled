...
namespace UnityEngine
{
  ...
  {
    public TouchScreenKeyboard keyboardOnScreen = (TouchScreenKeyboard) null;
    ...
    {
      this.m_iAltCursorPos = Mathf.Min(this.text.Length, this.style.GetCursorStringIndex(this.localPosition, this.m_Content, cursorPosition + this.scrollOffset));
      this.DetectFocusChange();
    }
    ...
    {
      return char.IsLetterOrDigit(c) || (int) c == 39;
    }
