...
namespace UnityEngine.Rendering
{
  public struct RenderTargetIdentifier
  {
    ...
    public RenderTargetIdentifier(Texture tex)
    {
      ...
      this.m_NameID = -1;
      this.m_InstanceID = !(bool) ((UnityEngine.Object) tex) ? 0 : tex.GetInstanceID();
      this.m_MipLevel = 0;
      this.m_CubeFace = CubemapFace.Unknown;
      this.m_DepthSlice = 0;
    }
    ...
    {
      return UnityString.Format("Type {0} NameID {1} InstanceID {2}", (object) this.m_Type, (object) this.m_NameID, (object) this.m_InstanceID);
    }
    ...
    public override bool Equals(object obj)
    {
      if (!(obj is RenderTargetIdentifier))
        return false;
      return this.Equals((RenderTargetIdentifier) obj);
    }
