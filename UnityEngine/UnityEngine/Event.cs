...
namespace UnityEngine
{
  ...
  public sealed class Event
  {
    ...
    {
      Event.s_Current = (Event) null;
      Event.s_MasterEvent = (Event) null;
    }
    ...
    public static Event KeyboardEvent(string key)
    {
      ...
      if (lower != null)
      {
        ...
        int num;
        // ISSUE: reference to a compiler-generated field
        if (Event.\u003C\u003Ef__switch\u0024map0.TryGetValue(lower, out num))
        {
          switch (num)
          {
            case 0:
...
label_73:
    ...
    public void Use()
    {
      if (this.type == EventType.Repaint || this.type == EventType.Layout)
        Debug.LogWarning((object) UnityString.Format("Event.Use() should not be called for events of type {0}", (object) this.type));
      this.Internal_Use();
    }
