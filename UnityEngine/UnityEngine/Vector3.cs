...
namespace UnityEngine
{
  ...
  public struct Vector3
  {
    ...
    {
      Vector3 normalized1 = from.normalized;
      Vector3 normalized2 = to.normalized;
      return Mathf.Acos(Mathf.Clamp(Vector3.Dot(normalized1, normalized2), -1f, 1f)) * 57.29578f * Mathf.Sign(Vector3.Dot(axis, Vector3.Cross(normalized1, normalized2)));
    }
