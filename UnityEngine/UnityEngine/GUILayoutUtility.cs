...
namespace UnityEngine
{
  ...
  public class GUILayoutUtility
  {
    ...
    {
      GUILayoutUtility.s_SpaceStyle = (GUIStyle) null;
    ...
    {
      GUILayoutUtility.current.topLevel.CalcWidth();
      GUILayoutUtility.current.topLevel.SetHorizontal(0.0f, w);
      GUILayoutUtility.current.topLevel.CalcHeight();
      GUILayoutUtility.current.topLevel.SetVertical(0.0f, h);
      GUILayoutUtility.LayoutFreeGroup(GUILayoutUtility.current.windows);
    }
    ...
    internal static void LayoutFreeGroup(GUILayoutGroup toplevel)
    {
      foreach (GUILayoutGroup entry in toplevel.entries)
        GUILayoutUtility.LayoutSingleGroup(entry);
    ...
    internal static void EndLayoutGroup()
    {
      ...
      int type = (int) Event.current.type;
      GUILayoutUtility.current.layoutGroups.Pop();
      GUILayoutUtility.current.topLevel = 0 >= GUILayoutUtility.current.layoutGroups.Count ? (GUILayoutGroup) null : (GUILayoutGroup) GUILayoutUtility.current.layoutGroups.Peek();
    }
