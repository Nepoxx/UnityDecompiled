...
namespace UnityEngine.Playables
{
  ...
  public struct PlayableGraph
  {
    ...
    {
      return new Playable(this.GetRootPlayableInternal(index));
    }
    ...
    {
      PlayableGraph ret;
      PlayableGraph.Create_Injected(out ret);
      return ret;
    }
    ...
    private bool GetOutputByTypeInternal(System.Type outputType, int index, out PlayableOutputHandle handle)
    {
    ...
    [MethodImpl(MethodImplOptions.InternalCall)]
    private static extern int GetOutputCountByTypeInternal_Injected(ref PlayableGraph _unity_self, System.Type outputType);

    [MethodImpl(MethodImplOptions.InternalCall)]
    private static extern bool GetOutputByTypeInternal_Injected(ref PlayableGraph _unity_self, System.Type outputType, int index, out PlayableOutputHandle handle);
