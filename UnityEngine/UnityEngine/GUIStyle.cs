...
namespace UnityEngine
{
  ...
  public sealed class GUIStyle
  {
    ...
    public RectOffset border
    {
      get
      {
        if (this.m_Border == null)
          this.m_Border = new RectOffset((object) this, this.GetRectOffsetPtr(0));
    ...
    public RectOffset margin
    {
      get
      {
        if (this.m_Margin == null)
          this.m_Margin = new RectOffset((object) this, this.GetRectOffsetPtr(1));
    ...
    public RectOffset padding
    {
      get
      {
        if (this.m_Padding == null)
          this.m_Padding = new RectOffset((object) this, this.GetRectOffsetPtr(2));
    ...
    public RectOffset overflow
    {
      get
      {
        if (this.m_Overflow == null)
          this.m_Overflow = new RectOffset((object) this, this.GetRectOffsetPtr(3));
    ...
    public bool isHeightDependantOnWidth
    {
      get
      {
        return (double) this.fixedHeight == 0.0 && (this.wordWrap && this.imagePosition != ImagePosition.ImageOnly);
      }
    }
    ...
    {
      IntPtr num;
      GUIStyle.INTERNAL_CALL_GetStyleStatePtr(this, idx, out num);
      return num;
    }
    ...
    {
      IntPtr num;
      GUIStyle.INTERNAL_CALL_GetRectOffsetPtr(this, idx, out num);
      return num;
    }
