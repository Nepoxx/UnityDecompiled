...
namespace UnityEngine
{
  ...
  public sealed class Rigidbody2D : Component
  {
    ...
    public Vector2 centerOfMass
    {
      ...
      {
        Vector2 ret;
        this.get_centerOfMass_Injected(out ret);
        return ret;
      }
      set
      {
    ...
    public Vector2 worldCenterOfMass
    {
      ...
      {
        Vector2 ret;
        this.get_worldCenterOfMass_Injected(out ret);
        return ret;
      }
    }
    ...
    public ColliderDistance2D Distance([Writable] Collider2D collider)
    {
      ...
      if ((Object) collider.attachedRigidbody == (Object) this)
    ...
    private ColliderDistance2D Distance_Internal([NotNull, Writable] Collider2D collider)
    {
      ...
      this.Distance_Internal_Injected(collider, out ret);
      return ret;
    }
    ...
    {
      Vector2 ret;
      this.GetPoint_Injected(ref point, out ret);
      return ret;
    }
    ...
    {
      Vector2 ret;
      this.GetRelativePoint_Injected(ref relativePoint, out ret);
      return ret;
    }
    ...
    {
      Vector2 ret;
      this.GetVector_Injected(ref vector, out ret);
      return ret;
    }
    ...
    {
      Vector2 ret;
      this.GetRelativeVector_Injected(ref relativeVector, out ret);
      return ret;
    }
    ...
    {
      Vector2 ret;
      this.GetPointVelocity_Injected(ref point, out ret);
      return ret;
    }
    ...
    {
      Vector2 ret;
      this.GetRelativePointVelocity_Injected(ref relativePoint, out ret);
      return ret;
    }
