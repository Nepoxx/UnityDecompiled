...
namespace UnityEditor.UI
{
  ...
  public class SelectableEditor : Editor
  {
    ...
    {
      SceneView.OnSceneFunc sceneGuiDelegate1 = SceneView.onSceneGUIDelegate;
      ...
      // ISSUE: reference to a compiler-generated field
      SceneView.OnSceneFunc fMgCache0 = SelectableEditor.\u003C\u003Ef__mg\u0024cache0;
      SceneView.onSceneGUIDelegate = sceneGuiDelegate1 - fMgCache0;
      if (SelectableEditor.s_Editors.Count <= 0)
        return;
      SceneView.OnSceneFunc sceneGuiDelegate2 = SceneView.onSceneGUIDelegate;
      // ISSUE: reference to a compiler-generated field
      ...
      // ISSUE: reference to a compiler-generated field
      SceneView.OnSceneFunc fMgCache1 = SelectableEditor.\u003C\u003Ef__mg\u0024cache1;
      SceneView.onSceneGUIDelegate = sceneGuiDelegate2 + fMgCache1;
    }
    ...
    public override void OnInspectorGUI()
    {
      ...
      {
        if (transition == Selectable.Transition.SpriteSwap && (UnityEngine.Object) (graphic as Image) == (UnityEngine.Object) null)
          EditorGUILayout.HelpBox("You must have a Image target in order to use a sprite swap transition.", MessageType.Warning);
      }
      else if ((UnityEngine.Object) graphic == (UnityEngine.Object) null)
    ...
    {
      string[] strArray = new string[3]{ "m_LocalScale.x", "m_LocalScale.y", "m_LocalScale.z" };
      AnimationCurve curve1 = new AnimationCurve(new Keyframe[3]{ new Keyframe(0.0f, 1f), new Keyframe(0.5f, 1.1f), new Keyframe(1f, 1f) });
      ...
      AnimationCurve curve2 = new AnimationCurve(new Keyframe[1]{ new Keyframe(0.0f, 1.15f) });
      foreach (string inPropertyName in strArray)
    ...
    private static void DrawNavigationForSelectable(Selectable sel)
    {
      ...
      SelectableEditor.\u003CDrawNavigationForSelectable\u003Ec__AnonStorey0 selectableCAnonStorey0 = new SelectableEditor.\u003CDrawNavigationForSelectable\u003Ec__AnonStorey0();
      if ((UnityEngine.Object) sel == (UnityEngine.Object) null)
        return;
      // ISSUE: reference to a compiler-generated field
      selectableCAnonStorey0.transform = sel.transform;
      // ISSUE: reference to a compiler-generated method
      Handles.color = new Color(1f, 0.9f, 0.1f, !((IEnumerable<Transform>) Selection.transforms).Any<Transform>(new Func<Transform, bool>(selectableCAnonStorey0.\u003C\u003Em__0)) ? 0.4f : 1f);
