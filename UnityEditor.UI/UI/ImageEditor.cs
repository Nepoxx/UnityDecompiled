...
namespace UnityEditor.UI
{
  ...
  public class ImageEditor : GraphicEditor
  {
    ...
    {
      int num;
      switch ((Image.Type) this.m_Type.enumValueIndex)
      {
        case Image.Type.Simple:
        case Image.Type.Filled:
          num = this.m_Sprite.objectReferenceValue != (UnityEngine.Object) null ? 1 : 0;
          break;
        default:
          num = 0;
          break;
      }
      this.SetShowNativeSize(num != 0, instant);
    }
    ...
    protected void TypeGUI()
    {
      ...
      EditorGUILayout.EndFadeGroup();
      if (EditorGUILayout.BeginFadeGroup(this.m_ShowTiled.faded) && (UnityEngine.Object) target.sprite != (UnityEngine.Object) null && !target.hasBorder && (target.sprite.texture.wrapMode != TextureWrapMode.Repeat || target.sprite.packed))
