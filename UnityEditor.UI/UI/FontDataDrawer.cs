...
namespace UnityEditor.UI
{
  ...
  public class FontDataDrawer : PropertyDrawer
  {
    ...
    private float m_FontFieldfHeight = 0.0f;
    private float m_FontStyleHeight = 0.0f;
    private float m_FontSizeHeight = 0.0f;
    private float m_LineSpacingHeight = 0.0f;
    private float m_EncodingHeight = 0.0f;
    private float m_ResizeTextForBestFitHeight = 0.0f;
    private float m_ResizeTextMinSizeHeight = 0.0f;
    private float m_ResizeTextMaxSizeHeight = 0.0f;
    private float m_HorizontalOverflowHeight = 0.0f;
    private float m_VerticalOverflowHeight = 0.0f;
    private float m_AlignByGeometryHeight = 0.0f;
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
      ...
      using (new EditorGUI.DisabledScope(!this.m_Font.hasMultipleDifferentValues && (Object) objectReferenceValue != (Object) null && !objectReferenceValue.dynamic))
    ...
    {
      int controlId = GUIUtility.GetControlID("AlignToggle".GetHashCode(), FocusType.Keyboard, position);
