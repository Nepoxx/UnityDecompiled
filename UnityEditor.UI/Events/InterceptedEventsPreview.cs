...
namespace UnityEditor.Events
{
  ...
  internal class InterceptedEventsPreview : ObjectPreview
  {
    ...
    public override void OnPreviewGUI(Rect r, GUIStyle background)
    {
      ...
      foreach (InterceptedEventsPreview.ComponentInterceptedEvents interceptedEvents in targetEvent)
      {
        foreach (int interceptedEvent in interceptedEvents.interceptedEvents)
        {
      ...
      foreach (InterceptedEventsPreview.ComponentInterceptedEvents interceptedEvents in targetEvent)
      {
        GUI.Label(position, interceptedEvents.componentName, this.m_Styles.componentName);
